...
from visualizacao import plota_matriz_de_confusao, decodifica_vetor_predicao
...
gerenciador = GerenciadorArquivos(
    "dados/caracteres-limpo.csv", tamanho_entrada=7)
...
X_treino, y_treino, X_validacao, y_validacao = gerenciador.separa_base_treinamento_validacao(
    X_caracteres, y_caracteres, percent_treino=0.7)

modelo.treina(X_treino, y_treino, epocas=10,
              conj_validacao=(X_validacao, y_validacao))
